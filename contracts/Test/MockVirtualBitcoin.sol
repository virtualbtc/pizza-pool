...
import "../VirtualBitcoin/VirtualBitcoinInterface.sol";

contract MockVirtualBitcoin is VirtualBitcoinInterface {
    ...
    uint256 public constant MAX_COIN = 21000000 * COIN;
    uint256 public constant PIZZA_POWER_PRICE = 10000 * COIN;
    ...
    constructor() {
        ...
        pizzas.push(Pizza({owner: msg.sender, power: 1, accSubsidy: 0}));

        totalPower = 1;
        mint(msg.sender, PIZZA_POWER_PRICE * 10000);
    }
    ...
    function makePizza(uint256 power) internal returns (uint256) {
        ...
        pizzas.push(Pizza({owner: msg.sender, power: power, accSubsidy: (_accSubsidy * power) / PRECISION}));
